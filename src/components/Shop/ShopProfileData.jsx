...
const ShopProfileData = ({ isOwner }) => {
  const { products } = useSelector((state) => state.products);
    // const [products,setProducts] = useState(productData);   // This is temporary static data
              ...
              <div className="w-full flex my-4">
                ...
                <div className="pl-2">
                  ...
                  <p className="text-[#000000a7] text-[14px]">
                    {item.createdAt ? new Date(item.createdAt).toLocaleDateString('en-US', {year:'numeric', month:'long', day:'numeric',}): null}
                  </p>
                </div>
              </div>
            ))}
