...
import { addToWishlistAsync, removeFromWishlistAsync } from "../../redux/actions/wishlist";
...
const ProductDetails = ({ data }) => {
  ...
  const addToCartHandler = (id) => {
    ...
    else if (isItemExists && (isItemExists.qty === count)) {
      toast.error("Item already in cart!");
    } 
    else if (data.stock < count && data.stock > 1) {
...
// Correct the code change image_Url to images Later
  return (
    isLoading ? <Loader/> : 
          ...
          <div className="w-full py-5">
            <div className="block w-full 800px:flex">
              ...
              <div className="w-full 800px:w-[50%]">
                <img src={`${data && data.images[select]?.url}`} alt="" className="rounded-lg w-[80%] ml-9 sm:ml-0"/>
                <div className="w-full flex">
                  {data && data.images.map((i, index) => (  
                      <div className={`${ select === index ? "border " : "null"} mr-2 mt-3 rounded-md cursor-pointer`} key={index}>
                        <img src={`${i?.url}`} alt="" className="h-[115px] sm:h-[150px] rounded-md overflow-hidden" onClick={() => setSelect(index)}/>
                      </div>
                    ))}
                </div>
              </div>
              ...
              <div className="w-full 800px:w-[50%] pt-5">
                ...
                <div className="my-6 flex justify-end">
                    {click ? (<AiFillHeart size={30} className="cursor-pointer" onClick={() => removeFromWishlistHandler(data)} color={click ? "red" : "#333"} title="Remove from wishlist"/>
                        ) : (
                ...
                <div className="flex items-center mt-0 justify-between pr-3">
                  <div>
                    ...
                    <span className="bg-gray-200 text-gray-800 font-medium px-4 py-[10.3px]">{count}</span>
    ...
    <div className="bg-[#f5f6fb] px-3 800px:px-10 py-2 rounded">
      <div className="w-full flex justify-between border-b pt-10 pb-2">
        ...
        <div className="relative">
          ...
          <span className="hidden sm:block">Product Reviews</span>
          </h5>
        ...
        <div className="relative">
          ...
          <span className="block sm:hidden">Information</span>
          <span className="hidden sm:block">Seller Information</span>
          </h5>
