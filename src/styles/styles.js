const styles = {
    ...
    productTitle: 'text-[15px] sm:text-[25px] font-[600] font-Roboto text-[#333]',
    ...
    button_addNew: 'w-[98px] lg:w-[150px] bg-black h-[40px] lg:h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    button_login: 'w-[80px] lg:w-[150px] bg-black h-[40px] lg:h-[45px] my-1 flex items-center justify-center rounded-xl cursor-pointer',
